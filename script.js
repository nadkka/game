...
function guzior0(){
    if(table[clicks]==0){
        ...
        if(table[table.length-1]==0){
            setTimeout(() => {
                document.getElementById("caly").innerHTML="<br> <br> <br> WYGRAŁEŚ!"
                document.getElementById("caly").style.fontSize="80px";
                document.getElementById("caly").style.color="white";
                document.getElementById("caly").style.backgroundColor="#2F8E3A";
                setTimeout(() => {
                    losowanie()
                }, 1000);
            }, 1000);
